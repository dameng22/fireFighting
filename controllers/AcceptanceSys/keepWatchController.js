 ...
 */
app.controller('keepWatchController', ['$scope','acceptance_http','$timeout','$base64','$stateParams',
	...
	$scope.get_list=function(){
		...
		acceptance_http.get_all_task({customerId:$base64.decode($stateParams.unit),pageNum:page_num,pageSize:page_size,nameAndCode:$scope.search_key,taskTypeId:0,checkStatus:net_status,beginTime:start_time},function(result){
