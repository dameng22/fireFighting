 ...
 */
app.controller('unitOnlineWaterController', ['$scope','acceptance_http','all_dic','exp_tool','$timeout','myself_alert','downloadFiles','$rootScope','dic_http','$state','$base64','$stateParams',
