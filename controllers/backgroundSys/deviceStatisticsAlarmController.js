 ...
 */
app.controller('deviceStatisticsAlarmController', ['$scope','background_http','$timeout','$base64','$stateParams','echart_round','acceptance_http','all_dic','dic_http','$filter','exp_tool','downloadFiles',
	...
	$scope.get_pie_list = function(){
		...
		background_http.get_pie_data({'regionId':area_id},function(result){
			...
			chart = echarts.init(document.getElementById('device_pie3'));
...
//      max:25,
    ...
    var resise;
   	$(window).resize(function(){
		resise = echarts.init(document.getElementById('device_pie3'));
