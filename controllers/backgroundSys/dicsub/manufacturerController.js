 ...
 */
app.controller('manufacturerController', ['$scope','dic_http','$timeout','myself_alert','$filter','$base64','$stateParams',
	...
	$scope.get_list=function(){
		page_num = page_num+1;
		dic_http.get_manufacturer({customerId:$base64.decode($stateParams.unit),isdisable:$scope.undo,pageNum:page_num,pageSize:page_size,typeId:0},function(result){
