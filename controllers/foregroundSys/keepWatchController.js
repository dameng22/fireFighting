 ...
 */
app.controller('keepWatchController', ['$scope','foreground_http','$timeout', function($scope,foreground_http,$timeout){
	//时分日历
	...
	$scope.get_list=function(){
		...
		foreground_http.get_all_task({customerSiteId:localStorage.unit_id,pageNum:page_num,pageSize:page_size,nameAndCode:$scope.search_key,taskTypeId:0,checkStatus:net_status,beginTime:start_time},function(result){
			if(result.results){
